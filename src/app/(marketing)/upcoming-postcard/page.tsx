          ...
          <div className="grid gap-10 md:grid-cols-2">
            ...
            <div>
              ...
              <div className="relative overflow-hidden rounded-xl border shadow-lg">
                <img
                  src="/upcoming-back.png"
                  alt="Postcard Back — Your Branding + Offer"
                  className="w-full"
                />
                {/* Cover the original name with a generic one */}
                <div className="absolute bottom-0 right-0 left-[15%] h-[12%] bg-white flex items-center justify-center">
                  <p className="text-xs md:text-sm font-bold text-gray-800 tracking-wide">
                    AS A GIFT FROM&nbsp; JESSICA TAYLOR
                  </p>
                </div>
              </div>
            </div>
